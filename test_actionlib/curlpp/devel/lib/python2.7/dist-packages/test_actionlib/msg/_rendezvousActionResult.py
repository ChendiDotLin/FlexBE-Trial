...
"""autogenerated by genpy from test_actionlib/rendezvousActionResult.msg. Do not edit."""
import sys
...
class rendezvousActionResult(genpy.Message):
  _md5sum = "273ece376ea6edff903dd061c760186b"
  _type = "test_actionlib/rendezvousActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','test_actionlib/rendezvousResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(rendezvousActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = test_actionlib.msg.rendezvousResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = test_actionlib.msg.rendezvousResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self
      buff.write(_get_struct_B2i2I3d().pack(_x.result.completed, _x.result.num_rb, _x.result.avg_real_dist, _x.result.stamp.secs, _x.result.stamp.nsecs, _x.result.centroid.x, _x.result.centroid.y, _x.result.centroid.z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.completed, _x.result.num_rb, _x.result.avg_real_dist, _x.result.stamp.secs, _x.result.stamp.nsecs, _x.result.centroid.x, _x.result.centroid.y, _x.result.centroid.z,) = _get_struct_B2i2I3d().unpack(str[start:end])
