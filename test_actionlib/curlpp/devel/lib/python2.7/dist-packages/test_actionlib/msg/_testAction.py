...
"""autogenerated by genpy from test_actionlib/testAction.msg. Do not edit."""
import sys
...
class testAction(genpy.Message):
  _md5sum = "85b1d4b076580845fe9ff76e00ac8376"
  _type = "test_actionlib/testAction"
...
"""
  ...
  _slot_types = ['test_actionlib/testActionGoal','test_actionlib/testActionResult','test_actionlib/testActionFeedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.action_goal is None:
        self.action_goal = test_actionlib.msg.testActionGoal()
      if self.action_result is None:
        self.action_result = test_actionlib.msg.testActionResult()
      if self.action_feedback is None:
        self.action_feedback = test_actionlib.msg.testActionFeedback()
    else:
      self.action_goal = test_actionlib.msg.testActionGoal()
      self.action_result = test_actionlib.msg.testActionResult()
      self.action_feedback = test_actionlib.msg.testActionFeedback()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_goal.goal.test_goal
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      _x = self.action_result.result.test_result
      length = len(_x)
      if python3 or type(_x) == unicode:
        _x = _x.encode('utf-8')
        length = len(_x)
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_i().pack(self.action_feedback.feedback.test_feedback))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.action_goal.goal.test_goal = str[start:end].decode('utf-8')
      else:
        self.action_goal.goal.test_goal = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_result.result.test_result = str[start:end].decode('utf-8')
      else:
        self.action_result.result.test_result = str[start:end]
      _x = self
      start = end
      end += 12
      ...
      (self.action_feedback.feedback.test_feedback,) = _get_struct_i().unpack(str[start:end])
      return self
